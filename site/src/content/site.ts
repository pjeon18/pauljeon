...
export const caseStudies: Record<string, CaseStudy> = {
  ...
  'org-chart-explorer': {
    ...
    title: 'Org Chart Explorer — org intelligence that never phones home.',
  ...
  'onapsis-gtm': {
    ...
    title: 'Onapsis — agentic prospecting for a BDR team.',
  ...
  'f1-undercut': {
    ...
    title: 'F1 Undercut Prediction — pit-wall calls from live telemetry.',
  ...
  'rl-agents': {
    ...
    title: 'RL Agents from scratch — Q-learning to CNNs.',
  ...
  'media-analytics': {
    ...
    title: 'Media Analytics — watching video formats shift.',
